            ...
            <div className='row p-5 mt-5 mb-5'>
                ...
                <div className='col-4 p-5 mt-2 mb-2'>
                    ...
                    <i class="fa fa-user" aria-hidden="true"></i> Your Zerodha Account
                        ...
                        <a href='' style={{ textDecoration: "none" , lineHeight: "2.5" }}>Account modification and segment addiion</a> <br></br>
                ...
                <div className='col-4 p-5 mt-2 mb-2'>
                    ...
                    <i class="fa fa-bar-chart" aria-hidden="true"></i> Trading And Markets
                        ...
                        <a href='' style={{ textDecoration: "none" , lineHeight: "2.5" }}>Trading FQAs</a> <br></br>
                ...
                <div className='col-4 p-5 mt-2 mb-2'>
                    ...
                    <i class="fa fa-circle-o-notch" aria-hidden="true"></i> Console
                        ...
                        <a href='' style={{ textDecoration: "none" , lineHeight: "2.5" }}>Fund statement</a> <br></br>
